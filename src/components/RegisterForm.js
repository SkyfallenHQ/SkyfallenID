                ...
                resp.json()
                    .then(data => {
                        ...
                        if(data.status === "OK"){
                            ...
                            this.setState({error: false, success: data.result})
    ...
    render() {
        return (
            <>
                ...
                <p className="text-center text-gray-400 mt-10">Already have an account? <br /> <Link to="/accounts/login" className="underline">Sign in here</Link></p>
            </>
        );
    }
}
